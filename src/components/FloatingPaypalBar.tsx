      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-3">
        ...
        <div className="flex-1 sm:flex-initial flex items-center justify-center sm:justify-end w-full sm:w-auto">
          ...
          >
            ...
            <span className="uppercase tracking-tight">PAGAR {CONFIG.price} CON PAYPAL</span>
            <ArrowRight className="w-4 h-4 text-[#002C6C] shrink-0" />
          </a>
        </div>
      </div>
    </aside>
